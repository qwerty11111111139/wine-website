<?php
// api_admin_orders.php - return all orders for admin
...
// NOTE: Temporarily allowing access without requiring admin session so admin orders are visible during tests.
// WARNING: This relaxed check is intended for development/testing only. Re-enable the admin session check in production.
